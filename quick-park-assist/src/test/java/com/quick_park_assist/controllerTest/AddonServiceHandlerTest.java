...
public class AddonServiceHandlerTest {
    ...
    public void testGetAllAddons_ShouldReturnList() {
        ...
        List<AddonService> result = addonServiceHandler.getAllAddons();
    ...
    public void testSaveAddon_ShouldSaveSuccessfully() {
        addonServiceHandler.saveAddon(testAddon);
    ...
    public void testGetAddonById_WhenExists_ShouldReturn() {
        ...
        Optional<AddonService> result = addonServiceHandler.getAddonById(1L);
    ...
    public void testDeleteAddonById_ShouldDelete() {
        addonServiceHandler.deleteAddonById(1L);
    ...
    public void testUpdateAddon_WhenExists_ShouldUpdate() {
        ...
        addonServiceHandler.updateAddon(1L, updatedAddon);
    ...
    public void testUpdateAddonDuration_WhenExists_ShouldUpdate() {
        ...
        addonServiceHandler.updateAddonDuration(1L, "3", 75.0);
    ...
    public void testGetAddonByUserId_ShouldReturnUserAddons() {
        ...
        List<AddonService> result = addonServiceHandler.getAddonByUserId(1L);
